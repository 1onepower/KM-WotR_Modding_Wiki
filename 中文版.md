...
**最新补充**：TTT现在分为多个部分，[TabletopTweaks-Core](https://github.com/Vek17/TabletopTweaks-Core/releases)（**必备**，是TTT所有子mod的核心，也为了方便其他mod作者做兼容）、[TabletopTweaks-Base](https://github.com/Vek17/TabletopTweaks-Base)（基础的桌面规则调整和BUG修复，也就是推荐的安装的部分）、[TabletopTweaks-Reworks](https://github.com/Vek17/TabletopTweaks-Reworks)（作者对于游戏原创的神话道途改动部分）......
