...
[TabletopTweaks-Reworks](https://github.com/Vek17/TabletopTweaks-Reworks)（作者对于游戏原创的神话道途改动部分，酌情选用；新手建议不装，或者装了以后把大部分改动关了只保留自己喜欢的部分---关键是新手也看不懂。。。）

简称TTT，大型内容更新包，~~推荐所有玩家使用，推荐一周目使用~~【注：目前由于游戏更新，原版很多东西都已经修复或更改了。目前TTT里的部分改动已经不合适或者过时了，比如元素狂潮改动、神话专长替换神话能力的次数和敌人BUFF的施法者等级，要玩这个MOD，以上三个条目务必关闭】。其主要功能是修复Owlcat的许多恶性滥强BUG/房规，实装了几乎所有没做完的职业和物品，其次补充了一部分很有趣、且适合电子游戏的桌游PF的资源。另一突出的优点是此MOD几乎所有的功能都可以在设置中关闭，并且所有的开关功能有完美的存档兼容性。如果你坚持想要原版游戏的某些良性BUG，大可自行修改。
